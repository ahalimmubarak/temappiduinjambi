<section class="relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto relative z-10 py-20 px-5">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="https://pmb.uinjambi.ac.id/category/berita/" class="flex items-center justify-end gap-3 italic hover:underline text-right font-medium text-black leading-tight">
                Baca berita lainnya 
